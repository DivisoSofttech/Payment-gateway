...
import com.diviso.payment.config.ApplicationProperties;
import com.diviso.payment.config.DefaultProfileUtil;
...
@ComponentScan(excludeFilters = {
	    @ComponentScan.Filter(com.diviso.payment.client.ExcludeFromComponentScan.class)
	})
